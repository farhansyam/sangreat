<div class="flex justify-between items-center w-full py-[11px] px-16 border border-t-0 border-b-[1px] border-l-0 border-r-0" style="background-color:#42A3A7">
    {{-- Currency Switcher --}}
    <x-shop::dropdown>
        <!-- Dropdown Toggler -->
        <x-slot:toggle>
            <div class="flex gap-[10px] cursor-pointer" style="color:#ffff">
                <span>
