<div class="w-full flex justify-between min-h-[78px] px-[60px] border border-t-0 border-b-[1px] border-l-0 border-r-0 max-1180:px-[30px]" style="color:#42A3A7">
    {{--
    ...
    <div class="flex items-center gap-x-[40px] pt-[28px] max-[1180px]:gap-x-[20px]">
        <a href="{{ route('shop.home.index') }}" class="place-self-start -mt-[4px]" aria-label="Sangreat ">
    ...
    <div class="flex gap-x-[35px] items-center max-lg:gap-x-[30px] max-[1100px]:gap-x-[25px]">
        ...
        <form action="{{ route('shop.search.index') }}" class="flex items-center max-w-[445px]">
            ...
            <div class="relative w-full">
                ...
                <input type="text" name="query" value="{{ request('query') }}" class="block w-full px-[44px] py-[13px] bg-[#F5F5F5] rounded-lg text-gray-900 text-xs font-medium transition-all border border-transparent hover:border-gray-400 focus:border-gray-400" placeholder="@lang('shop::app.components.layouts.header.search-text')" required>
            ...
            <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                ...
                <x-slot:content>
                    ...
                    <div class="flex gap-[16px] mt-[25px]">
                        <a href="{{ route('shop.customer.session.create') }}" class="primary-button block w-max px-[29px] mx-auto m-0 ml-[0px] rounded-[18px] text-base text-center">
                            @lang('shop::app.components.layouts.header.sign-in')
                        </a>

                        <a href="{{ route('shop.customers.register.index') }}" class="secondary-button block w-max m-0 ml-[0px] mx-auto px-[29px] border-2 rounded-[18px] text-base text-center">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <span>
                        <a href="?page=maklon" class="inline-block pb-[21px] px-[20px] uppercase">Maklon</a>
                    </span>
                    <span>
                        <a href="?page=rewards" class="inline-block pb-[21px] px-[20px] uppercase">Rewards</a>
                    </span>
                    <span>
                        <a href="?page=about" class="inline-block pb-[21px] px-[20px] uppercase">About us</a>
                    </span>
        </div>
