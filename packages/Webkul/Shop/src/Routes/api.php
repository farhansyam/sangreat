...
Route::group(['middleware' => ['locale', 'theme', 'currency'], 'prefix' => 'api'], function () {
    Route::controller(CoreController::class)->prefix('core')->group(function () {
        ...
        Route::get('provinsi', 'getProvinsi')->name('shop.api.core.provinsi');
        Route::get('kota', 'getKota')->name('shop.api.core.kota');
        Route::get('cost', 'getCost')->name('shop.api.core.cost');
    });
