...
class POSDua extends AbstractShipping
{
    /**
     ...
     * @var string
     */
    protected $method = 'posdua_posdua';
    ...
    public function getRate(): \Webkul\Checkout\Models\CartShippingRate | false
    {
        ...
        if(array_key_exists(1,$response)){
            $cartShippingRate->carrier_title = 'POS '.$response[1]['service'];
            $cartShippingRate->method = $this->getMethod();
            $cartShippingRate->method_title = 'POS '.$response[1]['service'];
